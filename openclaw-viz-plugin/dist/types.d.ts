...
export type PluginHookName = "model_call_started" | "model_call_ended" | "llm_input" | "llm_output" | "before_tool_call" | "after_tool_call" | "before_compaction" | "after_compaction" | "session_start" | "session_end" | "message_received" | "message_sent";
...
export interface OpenClawPluginApi {
    ...
    registerHook: (events: string | string[], handler: (event: any, ctx: any) => Promise<any> | any, opts?: OpenClawPluginHookOptions) => void;
    on: <K extends PluginHookName>(hookName: K, handler: (event: any) => void, opts?: OpenClawPluginHookOptions) => void;
}
